...
set c_compiler_flags=-DDEBUG -DAVX2 -std=c17 -O3 -ffast-math -fno-trapping-math -mavx2	
...
call time.bat clang %c_compiler_flags% %warnings% %allowed_extensions% %linker_flags% ../code/sec3.c -o sec3.exe

if %ERRORLEVEL% == 0 goto :execute_prog
goto :end
